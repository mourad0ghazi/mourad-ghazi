// ─────────────────────────────────────────────────────────────
// LifeOS – Panneau de paramètres (8 sections)
// Profil, Apparence, Langue & région, Dashboard, Notifications,
// Données, Sécurité, Raccourcis, Premium
// ─────────────────────────────────────────────────────────────
...
export function SettingsPanel({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const SHORTCUTS: { keys: string; label: string }[] = [
    { keys: '/', label: t('set.kSearch') },
    { keys: 'N', label: t('set.kTask') },
    { keys: 'Shift + N', label: t('set.kNote') },
    { keys: 'T', label: t('set.kTheme') },
    { keys: 'P', label: t('set.kPomo') },
    { keys: '?', label: t('set.kShortcuts') },
          ...
          <div>
            <div className="settings-row">
              <span>
                ...
                <div className="sr-desc">{t('set.notifToggle')}</div>
              </span>
